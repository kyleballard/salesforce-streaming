    ...
    public class BayeuxClient : AbstractClientSession, IBayeux
    {
        ...
        protected void processHandshake(IMutableMessage handshake)
        {
            if (handshake.Successful)
            {
                ...
                //serverTransports.Add(serverTransportObject);
                List<Object> serverTransports = ((JArray)serverTransportObject).ToObject<List<Object>>();
                ...
                if (newTransport == null)
                {
                    ...
                    Console.WriteLine("Handshake failed: {0}", error);
        ...
        {
            Console.WriteLine("Processing message {0}", message.JSON);
            receive(message);
        }
